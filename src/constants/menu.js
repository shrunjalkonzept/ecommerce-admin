    ...
    subs: [
      {
        ...
        label: 'Brand',
        to: `${adminRoot}/applications/brand`,
      },
      {
        icon: 'simple-icon-layers',
        label: 'Category',
        to: `${adminRoot}/applications/category`,
      },
      {
        icon: 'iconsminds-bag-items',
        label: 'Product',
        to: `${adminRoot}/applications/product`,
      },
      {
        icon: 'iconsminds-gift-box',
        label: 'Offers',
        to: `${adminRoot}/applications/Offers`,
      },

      {
        icon: 'iconsminds-receipt-4',
        label: 'Orders',
        to: `${adminRoot}/applications/orders`,
      },
    ],
  },
  {
    ...
    subs: [
      ...
      },
      {
        ...
        label: 'Blog',
        to: `${adminRoot}/applications/blog`,
      },
      // {
